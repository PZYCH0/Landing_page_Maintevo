      ...
      <section id="features" style={{padding:'120px 0',background:'#050b16'}} className="bg-grid">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {([
              { to:'/features/work-orders',           titleKey:'home.features.workOrders_title', descKey:'home.features.workOrders_desc', stroke:'#60a5fa', icon:'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4', delay:'d1', img:'https://images.unsplash.com/photo-1581094288338-2314dddb7ece?w=800&q=80' },
              { to:'/features/equipment',             titleKey:'home.features.equipment_title',  descKey:'home.features.equipment_desc',  stroke:'#60a5fa', icon:'M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v5.172a2 2 0 00.586 1.414l5 5c1.26 1.26.367 3.414-1.415 3.414H4.828c-1.782 0-2.674-2.154-1.414-3.414l5-5A2 2 0 009 10.172V5L8 4z', delay:'d2', img:'https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?w=800&q=80' },
              { to:'/features/preventive-maintenance', titleKey:'home.features.preventive_title', descKey:'home.features.preventive_desc', stroke:'#60a5fa', icon:'M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z', delay:'d3', img:'https://images.unsplash.com/photo-1581092918056-0c4c3acd3789?w=800&q=80' },
              { to:'/features/inventory',             titleKey:'home.features.inventory_title',  descKey:'home.features.inventory_desc',  stroke:'#60a5fa', icon:'M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4', delay:'d4', img:'https://images.unsplash.com/photo-1553413077-190dd305871c?w=800&q=80' },
              { to:'/features/kpi-dashboard',         titleKey:'home.features.kpi_title',        descKey:'home.features.kpi_desc',        stroke:'#22d3ee', icon:'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z', delay:'d1', img:'https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=800&q=80' },
              { to:'/features/maintenance-calendar',  titleKey:'home.features.calendar_title',   descKey:'home.features.calendar_desc',   stroke:'#22d3ee', icon:'M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z', delay:'d2', img:'https://images.unsplash.com/photo-1506784983877-45594efa4cbe?w=800&q=80' },
              { to:'/features/roles',                 titleKey:'home.features.roles_title',      descKey:'home.features.roles_desc',      stroke:'#22d3ee', icon:'M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z', delay:'d3', img:'https://images.unsplash.com/photo-1522071820081-009f0129c71c?w=800&q=80' },
              { to:'/features/reporting',             titleKey:'home.features.reporting_title',  descKey:'home.features.reporting_desc',  stroke:'#22d3ee', icon:'M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z', delay:'d4', img:'https://images.unsplash.com/photo-1554224155-8d04cb21cd6c?w=800&q=80' },
            ]).map((card, i) => (
              <Link key={i} className={`feat-card reveal ${card.delay} relative overflow-hidden flex flex-col`} to={card.to}>
