...
const industries = [
  {
    ...
    img: 'https://plus.unsplash.com/premium_photo-1682144751367-bb10849f3253?w=800&q=80',
  },
  {
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {industries.map(ind => (
              <div key={ind.title} className="benefit-card">
                <div className="absolute inset-0 bg-cover bg-center z-0" style={{backgroundImage:`url('${ind.img}')`}}></div>
