    ...
    <>
      ...
      <section style={{background:'#050b16',paddingTop:'112px',paddingBottom:'64px'}}>
        <div className="max-w-screen-xl px-6 mx-auto lg:grid lg:grid-cols-2 lg:gap-16 items-center">
          <div>
            <p style={{fontSize:'.9rem',fontWeight:600,color:'#3b82f6',marginBottom:'10px',letterSpacing:'.06em',textTransform:'uppercase'}}>{t('about.mission.eyebrow')}</p>
            <h1 style={{fontSize:'clamp(2rem,4vw,3rem)',fontWeight:900,letterSpacing:'-.03em',color:'#fff',marginBottom:'24px',lineHeight:1.1}}>{t('about.mission.title')}</h1>
            <p style={{marginBottom:'16px',color:'#94a3b8',fontSize:'1.05rem',lineHeight:1.8}}>{t('about.mission.p1')}</p>
            <p style={{color:'#94a3b8',fontSize:'1.05rem',lineHeight:1.8}}>{t('about.mission.p2')}</p>
          </div>
      ...
      <section style={{background:'#080f1e',padding:'80px 0'}}>
        <div className="max-w-screen-xl px-6 mx-auto">
          <h2 style={{fontSize:'clamp(1.8rem,3vw,2.4rem)',fontWeight:900,textAlign:'center',color:'#fff',marginBottom:'48px',letterSpacing:'-.03em'}}>{t('about.values.title')}</h2>
          <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
            <div style={{padding:'28px',background:'rgba(255,255,255,.03)',border:'1px solid rgba(255,255,255,.07)',borderRadius:'16px',textAlign:'center'}}>
              ...
              <h3 style={{fontSize:'1.2rem',fontWeight:700,color:'#fff',marginBottom:'10px'}}>{t('about.values.reliability_title')}</h3>
              <p style={{color:'#94a3b8',lineHeight:1.7}}>{t('about.values.reliability_desc')}</p>
            </div>
            <div style={{padding:'28px',background:'rgba(255,255,255,.03)',border:'1px solid rgba(255,255,255,.07)',borderRadius:'16px',textAlign:'center'}}>
              <div style={{display:'flex',justifyContent:'center',marginBottom:'20px'}}>
                <div style={{padding:'14px',background:'rgba(59,130,246,.1)',border:'1px solid rgba(59,130,246,.2)',borderRadius:'50%'}}>
              ...
              <h3 style={{fontSize:'1.2rem',fontWeight:700,color:'#fff',marginBottom:'10px'}}>{t('about.values.simplicity_title')}</h3>
              <p style={{color:'#94a3b8',lineHeight:1.7}}>{t('about.values.simplicity_desc')}</p>
            </div>
            <div style={{padding:'28px',background:'rgba(255,255,255,.03)',border:'1px solid rgba(255,255,255,.07)',borderRadius:'16px',textAlign:'center'}}>
              <div style={{display:'flex',justifyContent:'center',marginBottom:'20px'}}>
                <div style={{padding:'14px',background:'rgba(59,130,246,.1)',border:'1px solid rgba(59,130,246,.2)',borderRadius:'50%'}}>
              ...
              <h3 style={{fontSize:'1.2rem',fontWeight:700,color:'#fff',marginBottom:'10px'}}>{t('about.values.partnership_title')}</h3>
              <p style={{color:'#94a3b8',lineHeight:1.7}}>{t('about.values.partnership_desc')}</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section style={{background:'#050b16',padding:'80px 0'}}>
        <div className="max-w-screen-xl px-6 mx-auto">
          <h2 style={{fontSize:'clamp(1.8rem,3vw,2.4rem)',fontWeight:900,textAlign:'center',color:'#fff',marginBottom:'48px',letterSpacing:'-.03em'}}>{t('about.team.title')}</h2>
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
            {([
              { nameKey:'about.team.m1_name', roleKey:'about.team.m1_role', bioKey:'about.team.m1_bio' },
              { nameKey:'about.team.m2_name', roleKey:'about.team.m2_role', bioKey:'about.team.m2_bio' },
              { nameKey:'about.team.m3_name', roleKey:'about.team.m3_role', bioKey:'about.team.m3_bio' },
            ]).map((member) => (
              <div key={member.nameKey} style={{textAlign:'center'}}>
                ...
                <h3 style={{fontSize:'1.05rem',fontWeight:700,color:'#fff',marginBottom:'4px'}}>{t(member.nameKey)}</h3>
                <p style={{fontSize:'.875rem',color:'#3b82f6',marginBottom:'8px'}}>{t(member.roleKey)}</p>
                <p style={{fontSize:'.875rem',color:'#94a3b8',lineHeight:1.6}}>{t(member.bioKey)}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section style={{background:'rgba(59,130,246,.08)',borderTop:'1px solid rgba(59,130,246,.15)',borderBottom:'1px solid rgba(59,130,246,.15)',padding:'80px 0'}}>
        <div className="max-w-screen-xl px-6 mx-auto text-center">
          <h2 style={{fontSize:'clamp(1.8rem,3vw,2.4rem)',fontWeight:900,color:'#fff',marginBottom:'16px',letterSpacing:'-.03em'}}>{t('about.cta.title')}</h2>
          <p style={{marginBottom:'28px',color:'#94a3b8',fontSize:'1.05rem'}}>{t('about.cta.desc')}</p>
          <a href="/contact" style={{display:'inline-flex',alignItems:'center',gap:'8px',background:'linear-gradient(135deg,#3b82f6,#2563eb)',color:'#fff',borderRadius:'10px',padding:'14px 36px',fontWeight:600,fontSize:'15px',textDecoration:'none',boxShadow:'0 4px 20px rgba(59,130,246,.4)'}}>{t('about.cta.button')}</a>
        </div>
      </section>
    </>
  );
