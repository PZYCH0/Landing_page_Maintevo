# MaintEvo — Landing Page

Marketing and product landing page for **MaintEvo**, a CMMS (Computerized Maintenance Management System) platform built for industrial maintenance teams.

---

## Overview

MaintEvo is a dark-themed, multi-page React application that presents the product, features, pricing, and company information to prospective customers. The design language uses a deep navy background (`#020617`), blue accents (`#3b82f6`), and a consistent card-based layout across all pages.
